  ...
  return (
    <div className="App">
      ...
      <div id="top">
        ...
        <h5 className="resume-line">View my resume here: <a id='resume-tag' target="_blank" href="https://docs.google.com/document/d/1uBMhU9y2tSFuCXr9cszS7IfctmssRTw4/edit?usp=sharing&ouid=110742230443125215815&rtpof=true&sd=true">Resume</a></h5>
      </div>
      <div id="portfolio">
        <div className="padding-section"></div>
      ...
      <div id="contact">
        ...
        <h5 className="resume-line">View my resume here: <a id='resume-tag' target="_blank" href="https://docs.google.com/document/d/1uBMhU9y2tSFuCXr9cszS7IfctmssRTw4/edit?usp=sharing&ouid=110742230443125215815&rtpof=true&sd=true">Resume</a></h5>
        <a class='btn btn-outline-dark btn-social mx-1' target="_blank" href="https://www.linkedin.com/in/scottmacleod1990">
