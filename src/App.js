  ...
  return (
    <div className="App">
      ...
      <div id="top">
        ...
        <h5 className="resume-line">View my resume here: <a id='resume-tag' target="_blank" href="https://docs.google.com/document/d/1KHIcULALFiGgQsujGFJM95bB1BJQbm4W/edit?usp=sharing&ouid=110742230443125215815&rtpof=true&sd=true">Resume</a></h5>
      </div>
      <div id="portfolio">
        <div className="padding-section"></div>
